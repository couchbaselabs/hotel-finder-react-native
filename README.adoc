...
----
. Build & run. You should now see the list of hotels on the screen after clicking the *Lookup* button.
...
[source,javascript]
----
include::{snippet}/HotelFinderBridge.swift[tag=unbookmark-method-js,indent=0]
----