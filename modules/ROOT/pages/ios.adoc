...
[source,swift]
----
include::../assets/attachments/HotelFinder/App.js[tag=import-statement,indent=0]
----
...
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/HotelFinderBridge.swift[tag=lazy-database,indent=0]
----
...
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/RCTBridge.m[tag=search-hotels-method-signature,indent=0]
----
. Implement this method in `HotelFinderBridge.swift`.
+
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/HotelFinderBridge.swift[tag=search-hotels-method-impl,indent=0]
----
. Use this method on the Hotels screen.
+
[source,swift]
----
include::../assets/attachments/HotelFinder/Hotels.js[tag=search-hotels-js,indent=0]
----
. Build & run.
...
[source,objectivec]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/RCTBridge.m[tag=bookmark-method-signature,indent=0]
----
. Implement this method in *HotelFinderBridge.swift*.
+
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/HotelFinderBridge.swift[tag=bookmark-method-swift,indent=0]
----
. Use this method on the Hotels screen.
+
[source,javascript]
----
include::../assets/attachments/HotelFinder/Hotels.js[tag=bookmark-method-js,indent=0]
----
. Build & run.
...
[source,objectivec]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/RCTBridge.m[tag=bookmark-list-signature,indent=0]
----
. Implement this method in *HotelFinderBridge.swift*.
+
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/HotelFinderBridge.swift[tag=bookmark-list-method-swift,indent=0]
----
. Use this method on the Home Screen.
+
[source,javascript]
----
include::../assets/attachments/HotelFinder/BookmarkedHotels.js[tag=bookmark-list-method-js,indent=0]
----
...
[source,objectivec]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/RCTBridge.m[tag=unbookmark-method-signature,indent=0]
----
. Implement this method in `HotelFinderBridge.swift`.
+
[source,swift]
----
include::../assets/attachments/HotelFinder/ios/HotelFinder/HotelFinderBridge.swift[tag=unbookmark-method-swift,indent=0]
----
. Call this method on the Hotels Screen (*Hotels.js*), in the `unbookmarkHotel` method.
+
[source,javascript]
----
include::../assets/attachments/HotelFinder/Hotels.js[tag=unbookmark-method-js,indent=0]
----