...
The User Interface has already been implemented in the link:{attachmentsdir}/final-project.zip[starter project].

. Download the link:{attachmentsdir}/final-project.zip[starter project].
